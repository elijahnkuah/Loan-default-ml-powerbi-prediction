...
loan_data_inputs_train = pd.read_csv('datasets/loan_data_inputs_train.csv', index_col = 0,low_memory=False)
loan_data_targets_train = pd.read_csv('datasets/loan_data_targets_train.csv', index_col = 0, header = None,low_memory=False)
loan_data_inputs_test = pd.read_csv('datasets/loan_data_inputs_test.csv', index_col = 0)
loan_data_targets_test = pd.read_csv('datasets/loan_data_targets_test.csv', index_col = 0, header = None,low_memory=False)
...
loan_data_targets_test = loan_data_targets_test_temp


# In[56]:


#loan_data_targets_test_temp_1 = loan_data_targets_test_temp.reset_index(drop = True, inplace = True)
...
df_actual_predicted_probs.columns = ['loan_data_targets_test_temp', 'y_hat_test_proba']
...
df_actual_predicted_probs['loan_data_targets_test_temp']= pd.to_numeric(df_actual_predicted_probs['loan_data_targets_test_temp'])


# In[192]:


roc_curve(df_actual_predicted_probs['loan_data_targets_test_temp'], df_actual_predicted_probs['y_hat_test'])
...
AUROC = roc_auc_score(df_actual_predicted_probs['loan_data_targets_test_temp'], df_actual_predicted_probs['y_hat_test_proba'])
...
df_actual_predicted_probs['Cumulative N Good'] = df_actual_predicted_probs['loan_data_targets_test_temp'].cumsum()
# We calculate cumulative number of 'good', which is the cumulative sum of the column with actual observations.
df_actual_predicted_probs['Cumulative N Bad'] = df_actual_predicted_probs['Cumulative N Population'] - df_actual_predicted_probs['loan_data_targets_test_temp'].cumsum()
...
df_actual_predicted_probs['Cumulative Perc Good'] = df_actual_predicted_probs['Cumulative N Good'] / df_actual_predicted_probs['loan_data_targets_test_temp'].sum()
# We calculate cumulative percentage of 'good'.
df_actual_predicted_probs['Cumulative Perc Bad'] = df_actual_predicted_probs['Cumulative N Bad'] / (df_actual_predicted_probs.shape[0] - df_actual_predicted_probs['loan_data_targets_test_temp'].sum())
